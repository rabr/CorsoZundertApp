		...
		$.when($.getJSON(graphUSER),$.getJSON(graphPOSTS)).done(function(user,posts){
			...
			$.each(posts[0].data,function(){
				...
				*/
				...
				this.from.picture = 'https://graph.facebook.com/'+this.from.id+'/picture';
				...
				if (this.message) this.message = urlHyperlinks(this.message);
				
				// Retrieve picture
				if (this.type == 'photo') {
				   this.pictureurl = 'https://graph.facebook.com/'+this.object_id+'/picture?access_token='+options.access_token;
				}
