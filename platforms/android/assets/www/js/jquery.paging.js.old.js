...
(function( $ ) {
   ...
   $.fn.paging = function( options ) {
      ...
      var scrollT, scrollL, startX, startY, initialTouchDir, enabled;
      ...
      return this.each(function() {
         ...
         elem.on('touchstart', function(e) {
            enabled = jQuery(this).children(settings.snaps).filter(function() {
                  return $(this).css('visibility') == 'visible';
                }).length > 1;
      
            if (enabled) {
               scrollT = jQuery(this).scrollTop();
		         scrollL = jQuery(this).scrollLeft();
         ...
         elem.on('touchmove', function(e) {
            if (enabled) {
               var ty = scrollT + startY - e.originalEvent.touches[ 0 ].pageY,
			          ...
			          sl = jQuery(this).scrollLeft() - scrollL,
		         ...
		         if (initialTouchDir == 'page') {					
		            ...
		            //jQuery(this).scrollTop(ty);
		            jQuery(this).scrollLeft(tx);
		         }
               ...
               var pages = jQuery(this).children(settings.snaps).filter(function() {
                              return $(this).css('visibility') == 'visible';
                           }).length;
